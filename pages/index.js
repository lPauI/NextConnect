		...
		<>
			...
			<main className="home bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen">
					...
					<div className="container mx-auto px-6 md:px-12">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-12">
							{[
								...
								<div
									key={index}
									className="p-8 rounded-lg shadow-lg bg-white hover:shadow-2xl transition-all duration-300 animate-fade-in delay-300 flex flex-col items-center text-center"
								>
									<div className="text-4xl text-blue-600 mb-4 animate-scale-up">{item.icon}</div>
									<h3 className="text-2xl font-semibold text-blue-600 mb-4">{item.title}</h3>
									<p className="text-gray-600">{item.description}</p>
				...
				<section className="py-20 bg-gradient-to-r from-blue-500 to-purple-600 text-white">
					<div className="container mx-auto px-6 md:px-12 text-center">
						<h2 className="text-3xl md:text-4xl font-extrabold mb-4 animate-fade-in">Our Impact</h2>
						<p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 animate-fade-in delay-100">
							With the dedication of countless volunteers contributing thousands of hours, NextConnect
							will bring hope, support, and growth to communities across the globe.
						</p>
						<button
